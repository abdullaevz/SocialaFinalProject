...
namespace SocialApp.PERSISTENCE.Migrations
{
    ...
    [Migration("20250701115542_BannerAndAuthRestrictionTablesAreAdded2")]
    partial class BannerAndAuthRestrictionTablesAreAdded2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialApp.DOMAIN.Models.AuthRestriction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("LoginActionIsActive")
                        .HasColumnType("boolean");

                    b.Property<bool>("RegisterActionIsActive")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AuthRestrictions");
                });

            modelBuilder.Entity("SocialApp.DOMAIN.Models.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialApp.DOMAIN.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialApp.DOMAIN.Models.PostLike", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialApp.DOMAIN.Models.PostSave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialApp.DOMAIN.Models.UserBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialApp.DOMAIN.Models.Message", b =>
                {
                    b.HasOne("SocialApp.DOMAIN.Models.IdentityModels.AppUser", "Reciever")
                        .WithMany()
                        .HasForeignKey("RecieverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialApp.DOMAIN.Models.IdentityModels.AppUser", "Sender")
                        .WithMany()
